...
function formatUser(u: { id: number; phone: string; name: string; avatar: string | null; isOnline: boolean; lastSeen: Date | null }) {
  return { ...u, lastSeen: u.lastSeen ? u.lastSeen.toISOString() : null };
}
